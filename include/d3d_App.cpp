...
D3DApp* gd3dApp              = 0;
IDirect3DDevice9* g_pD3Device = 0;

//float UI_MINZ = 0.0001f;
//float UI_MAXZ = 0.01f;
//float UI_DZPOS = 0.001f;
...
void D3DApp::initDirect3D()
{
	...
	HR(md3dObject->CreateDevice(
	    ...
	    &g_pD3Device));      // return created device
}
...
bool D3DApp::isDeviceLost()
{
	...
	HRESULT hr = g_pD3Device->TestCooperativeLevel();
