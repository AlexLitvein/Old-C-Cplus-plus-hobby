...
void D3DApp::initDirect3D()
{
	...
	HR3D(md3dObject->CheckDeviceType(D3DADAPTER_DEFAULT, mDevType, mode.Format, mode.Format, true));
	HR3D(md3dObject->CheckDeviceType(D3DADAPTER_DEFAULT, mDevType, D3DFMT_X8R8G8B8, D3DFMT_X8R8G8B8, false));

	// Step 3: Check for requested vertex processing and pure device.

	D3DCAPS9 caps;
	HR3D(md3dObject->GetDeviceCaps(D3DADAPTER_DEFAULT, mDevType, &caps));
